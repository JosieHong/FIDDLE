...
if __name__ == "__main__": 
    ...
    parser.add_argument('--pkl_dir', type=str, default='./data/ablation/',
    ...
    if len(nist20_spectra) > nist20_sample_size:
        ...
        print(f'NIST20 has fewer than {nist20_sample_size} spectra, using all {len(nist20_spectra)} spectra')
